            ...
            <div className={`flex flex-col`}>
                ...
                <div className={`my-0 mx-CustomerSpacingMargin customer-spacing relative max-sm:mx-[20px] flex flex-col items-center mt-[40px]`}>
                    ...
                    <CustomerText
                        title={"Результаты"}
                        numberText={[
                            "Зубная фея на данный момент получает порядка 50-60 качественных лидов в месяц, естественно такие заявки окупают затраты на контекстную рекламу, а также позволяют подключать дополнительные направления траффика – например, наружную рекламу и СММ.",
                            "Установили дополнительные сервисы для улучшения эффективности контекстной рекламы.",
                            "Помимо контекстной рекламы взяли в работу направление СММ и обязательно об этом расскажем в отдельном кейсе!",
